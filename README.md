...
Project Overview
This project implements a machine learning model to detect and classify Alzheimer's disease stages using clinical data. The model leverages diagnostic information, cognitive scores, and biomarker data to predict whether a patient is cognitively normal, has mild cognitive impairment, or has Alzheimer's disease.
...
Project Workflow
Data Loading: Load multiple sheets from Excel file
Data Cleaning: Remove missing values
Data Integration: Merge datasets on patient ID
